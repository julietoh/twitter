...
* [(implemented in previous twitter)] User can **pull down to refresh tweets** in either timeline.
...
* [(implemented in previous twitter)] User can view more tweets as they scroll with [infinite pagination](http://guides.codepath.com/android/Endless-Scrolling-with-AdapterViews-and-RecyclerView). Number of tweets is unlimited. 

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://g.recordit.co/LnEOPwmtKE.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
