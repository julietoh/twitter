...
//        scrollListener = new EndlessRecyclerViewScrollListener(fragmentTweetsList.linearLayoutManager) {
//            @Override
...
//                tweets.clear();
//                // loop thru json objects in array and convert each to a Tweet object
//                for (int i = 0; i < response.length(); i++) {
//                    try {
//                        Tweet tweet = Tweet.fromJSON(response.getJSONObject(i));
//                        tweets.add(i, tweet);
